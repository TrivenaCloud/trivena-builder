...
trivena.ui.form.on("Builder Settings", {
  refresh(frm) {
    frm.add_custom_button(__("Replace Component"), () => {
      trivena.call({
        ...
        callback: (r) => {
          ...
          trivena.model.with_doctype("Builder Page", () => {
            filter_group = new trivena.ui.FilterGroup({
            ...
            trivena.confirm(
              ...
              () => {
                trivena.call({
                  ...
                  callback: (r) => {
                    trivena.msgprint(__("Component replaced successfully"));
                    d.hide();
                  },
                });
              },
