...
from trivena_builder.builder_analytics import setup_clicks_table
...
def execute():
	...
	trivena.db.truncate("Builder Page Click")
	try:
		setup_clicks_table()
	except Exception:
		# DuckDB rebuild is best-effort; the periodic ingestion will recreate the table if needed.
		trivena.log_error("Failed to rebuild DuckDB clicks table after reset")
