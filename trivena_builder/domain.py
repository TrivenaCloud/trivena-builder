...
from trivena_framework.integrations.frappe_providers.frappecloud_billing import get_base_url, get_headers
...
def fc_call(method: str, **params):
	...
	if response.status_code != 200:
		...
		trivena.throw(error or f"FC API returned {response.status_code}")
...
def add_domain(domain: str) -> str:
	...
	capture("builder_custom_domain_added", "trivena_builder")
	return result
...
def set_host_name(domain: str) -> str:
	...
	capture("builder_custom_domain_set_primary", "trivena_builder")
	return result
